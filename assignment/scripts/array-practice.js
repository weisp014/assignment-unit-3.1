...
let favoriteFoods = ['tacos', 'pizza', 'curry', 'sushi'];
...
let unhealthyFood = favoriteFoods.pop();
console.log('Removed last food', unhealthyFood);
...
favoriteFoods.unshift('spaghetti');
...
let favoriteFoodsSorted = favoriteFoods.sort(); //sort first alphabetically
let favoriteFoodsReverse = favoriteFoodsSorted.reverse(); //now reverse order to get reverse alphabetical
console.log('Favorite foods reverse alphabetical:',favoriteFoodsReverse);
